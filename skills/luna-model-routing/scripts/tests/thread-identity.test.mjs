...
test('accepts nested project target with Git worktree', () => {
  const target = {
    target: {
      type: 'project',
      projectId: 'project-123',
      environment: { type: 'local', workspace: { type: 'worktree' } },
    },
...
test('accepts nested project target with non-Git local workspace', () => {
  const target = {
    target: {
      type: 'project',
      projectId: 'project-123',
      environment: { type: 'local', workspace: { type: 'local' } },
    },
...
test('rejects projectless, wrong environment, and mismatched workspace targets', () => {
  for (const target of [
    { type: 'projectless', projectId: 'project-123', environment: { type: 'local', workspace: { type: 'local' } }, project: { projectId: 'project-123', path: '/workspace/repo' } },
    { type: 'project', projectId: 'project-123', environment: { type: 'cloud', workspace: { type: 'worktree' } }, project: { projectId: 'project-123', path: '/workspace/repo' } },
